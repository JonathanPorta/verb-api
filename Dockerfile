...
CMD /bin/bash -c -l 'cd /home/app && bundle exec rake db:create && bundle exec rake db:setup && bundle exec rake db:migrate && foreman run bundle exec rails server -p 80'
